...
describe ProductsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'when a new product created' do
      ...
      it "'s valid details will be stored" do
        post :create, params:{product: {id: @product.id ,name: @product.name, description: @product.description, image_url: @product.image_url, size: @product.size, price: @product.price}}
  ...
  describe 'PUT/PATCH #update' do
    ...
    it "updates product's name" do
      @user_admin = FactoryBot.create(:admin)
      sign_in @user_admin
      @update = { id: @product_id, name: @product.name, size: @product.size, description: @product.description, image_url: @product.image_url,  price: @product.price }
